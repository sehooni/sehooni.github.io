...
"[project]/node_modules/@giscus/react/dist/giscus-Ci9LqPcC.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */ const { is: gt, defineProperty: ft, getOwnPropertyDescriptor: mt, getOwnPropertyNames: At, getOwnPropertySymbols: yt, getPrototypeOf: St } = Object, A = globalThis, Q = A.trustedTypes, vt = Q ? Q.emptyScript : "", Y = A.reactiveElementPolyfillSupport, U = (i, t)=>i, L = {
    toAttribute (i, t) {
        switch(t){
            case Boolean:
                i = i ? vt : null;
...
class E extends HTMLElement {
    ...
    static getPropertyDescriptor(t, e, s) {
        const { get: r, set: o } = mt(this.prototype, t) ?? {
            get () {
                return this[e];
            },
            set (n) {
    ...
    _$AK(t, e) {
        ...
        if (r !== void 0 && this._$Em !== r) {
            const n = s.getPropertyOptions(r), a = typeof n.converter == "function" ? {
                fromAttribute: n.converter
            } : ((o = n.converter) == null ? void 0 : o.fromAttribute) !== void 0 ? n.converter : L;
...
E.elementStyles = [], E.shadowRootOptions = {
    mode: "open"
}, E[U("elementProperties")] = /* @__PURE__ */ new Map(), E[U("finalized")] = /* @__PURE__ */ new Map(), Y == null || Y({
    ReactiveElement: E
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */ const P = globalThis, k = P.trustedTypes, tt = k ? k.createPolicy("lit-html", {
    createHTML: (i)=>i
}) : void 0, at = "$lit$", m = `lit$${Math.random().toFixed(9).slice(2)}$`, ct = "?" + m, Et = `<${ct}>`, v = document, M = ()=>v.createComment(""), N = (i)=>i === null || typeof i != "object" && typeof i != "function", F = Array.isArray, bt = (i)=>F(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", B = `[ 	
\f\r]`, w = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, et = /-->/g, st = />/g, y = RegExp(`>|${B}(?:([^\\s"'>=/]+)(${B}*=${B}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), it = /'/g, rt = /"/g, lt = /^(?:script|style|textarea|title)$/i, Ct = (i)=>(t, ...e)=>({
            _$litType$: i,
            strings: t,
            values: e
        }), wt = Ct(1), b = Symbol.for("lit-noChange"), l = Symbol.for("lit-nothing"), nt = /* @__PURE__ */ new WeakMap(), S = v.createTreeWalker(v, 129);
function dt(i, t) {
...
class R {
    constructor({ strings: t, _$litType$: e }, s){
        ...
        for(; (r = S.nextNode()) !== null && h.length < a;){
            if (r.nodeType === 1) {
                if (r.hasAttributes()) for (const c of r.getAttributeNames())if (c.endsWith(at)) {
                    ...
                    h.push({
                        ...
                        name: x[2],
                        strings: f,
                        ctor: x[1] === "." ? Ot : x[1] === "?" ? Tt : x[1] === "@" ? Mt : z
                    }), r.removeAttribute(c);
                } else c.startsWith(m) && (h.push({
                    type: 6,
                    index: o
                }), r.removeAttribute(c));
                if (lt.test(r.tagName)) {
                    ...
                    if (g > 0) {
                        ...
                        for(let f = 0; f < g; f++)r.append(c[f], M()), S.nextNode(), h.push({
                            type: 2,
                            index: ++o
                        });
                        r.append(c[g], M());
            ...
            } else if (r.nodeType === 8) if (r.data === ct) h.push({
                type: 2,
                index: o
            });
            else {
                let c = -1;
                for(; (c = r.data.indexOf(m, c + 1)) !== -1;)h.push({
                    type: 7,
                    index: o
                }), c += m.length - 1;
            }
...
var ot;
O._$litElement$ = !0, O.finalized = !0, (ot = globalThis.litElementHydrateSupport) == null || ot.call(globalThis, {
    LitElement: O
});
...
function _(i) {
    return (t, e)=>typeof e == "object" ? Ht(i, t, e) : ((s, r, o)=>{
            ...
            return r.constructor.createProperty(o, n ? {
                ...s,
                wrapped: !0
            } : s), n ? Object.getOwnPropertyDescriptor(r, o) : void 0;
        })(i, t, e);
}
/**
 * @license
...
var Kt = Object.defineProperty, Ft = Object.getOwnPropertyDescriptor, $ = (i, t, e, s)=>{
    for(var r = s > 1 ? void 0 : s ? Ft(t, e) : t, o = i.length - 1, n; o >= 0; o--)(n = i[o]) && (r = (s ? n(t, e, r) : n(r)) || r);
...
let p = class extends O {
    ...
    handleMessageEvent(i) {
        ...
        if (e.includes("Bad credentials") || e.includes("Invalid state value") || e.includes("State has expired")) {
            ...
            console.error(`${this._formatError(e)} No session is stored initially. ${this.ERROR_SUGGESTION}`);
        }
        if (e.includes("Discussion not found")) {
            console.warn(`[giscus] ${e}. A new discussion will be created if a comment/reaction is submitted.`);
            return;
        }
    ...
    sendMessage(i) {
        var t;
        !((t = this.iframeRef) != null && t.contentWindow) || !this.hasLoaded || this.iframeRef.contentWindow.postMessage({
            giscus: i
        }, this._host);
    }
    updateConfig() {
    ...
    getMetaContent(i, t = !1) {
        const e = t ? `meta[property='og:${i}'],` : "", s = document.querySelector(e + `meta[name='${i}']`);
        return s ? s.content : "";
    }
    _getCleanedUrl() {
...
//# sourceMappingURL=node_modules_%40giscus_react_dist_giscus-Ci9LqPcC_fb8469b4.js.map