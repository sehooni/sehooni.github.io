...
36:I[3089,["182","static/chunks/app/%5Bslug%5D/page-ad31c54747687caf.js"],"default"]
37:I[4010,["182","static/chunks/app/%5Bslug%5D/page-ad31c54747687caf.js"],"default"]
f:["$","p","p-22",{"children":["Jetpack version이 안 뜰 경우, 터미널에서 ",["$","strong","strong-0",{"children":"sdkmanager --archivedversions"}],"로 검색을 해주면 해당하는 버전을 선택할 수 있고 이를 통해 바로 접속이 가능하다."]}]
10:["$","p","p-23",{"children":"이후 젯슨나노는 아래와 같이 선택하여 주고, 위와 같이 3가지만 선택하여 준다."}]
11:["$","p","p-24",{"children":["$","img","img-0",{"src":"https://user-images.githubusercontent.com/84653623/219853919-d9f34231-74dc-4b4e-8322-0ebc0aedbc03.png","alt":"14"}]}]
12:["$","p","p-25",{"children":["$","img","img-0",{"src":"https://user-images.githubusercontent.com/84653623/219853921-47f60827-a140-4fbf-9bd9-ca73fcf18eb7.png","alt":"18"}]}]
13:["$","p","p-26",{"children":"이후 다음과 같은 화면이 뜨는데 메뉴얼로 셋업을 변경하고 진행하면 된다."}]
14:["$","p","p-27",{"children":["$","img","img-0",{"src":"https://user-images.githubusercontent.com/84653623/219853925-74e9bd3f-191d-4f1c-bada-7879b5a29b11.png","alt":"MicrosoftTeams-image"}]}]
15:["$","p","p-28",{"children":"설치가 다 되면 다음과 같은 화면이 뜬다!"}]
16:["$","p","p-29",{"children":"설치가 완료되면 범퍼를 다시 빼주고, emmc로 부팅을 하여준다."}]
17:["$","h2","h2-1",{"id":"2","className":"text-2xl font-bold mt-8 mb-4","children":"2. usb에 flash하기"}]
18:["$","h3","h3-3",{"id":"y","className":"text-xl font-bold mt-6 mb-3","children":"yahboom 공식 홈페이지 왼쪽 하단에서 다음의 파일 다운로드."}]
19:["$","p","p-30",{"children":["$","img","img-0",{"src":"https://user-images.githubusercontent.com/84653623/219853900-b1381c25-a442-4aef-a859-ccec211246a0.png","alt":"1"}]}]
1a:["$","p","p-31",{"children":"usb 부팅을 위한 파일"}]
1b:["$","h3","h3-4",{"id":"","className":"text-xl font-bold mt-6 mb-3","children":"구글 드라이브에서 다음의 파일 다운로드."}]
1c:["$","p","p-32",{"children":["$","img","img-0",{"src":"https://user-images.githubusercontent.com/84653623/219853903-9d619c65-ad8f-4216-a91a-20922b5320b5.png","alt":"2"}]}]
1d:["$","h3","h3-5",{"id":"","className":"text-xl font-bold mt-6 mb-3","children":"부팅 usb 내부 초기화."}]
1e:["$","p","p-33",{"children":["$","img","img-0",{"src":"https://user-images.githubusercontent.com/84653623/219853904-7b9f50a6-d440-4eec-b37e-d2ce10d2fc42.png","alt":"3"}]}]
1f:["$","h3","h3-6",{"id":"e","className":"text-xl font-bold mt-6 mb-3","children":"etcher 프로그램을 이용하여 os 파일 입력하기."}]
20:["$","p","p-34",{"children":["$","img","img-0",{"src":"https://user-images.githubusercontent.com/84653623/219853906-ddd50dcb-6c40-41b0-8572-bbdee429d5dc.png","alt":"4"}]}]
21:["$","ul","ul-0",{"children":["\n",["$","li","li-0",{"children":"flash가 완료되면 수 많은 페이지가 뜨는데 무시하고 usb 제거해주면 된다."}],"\n"]}]
22:["$","h2","h2-2",{"id":"3","className":"text-2xl font-bold mt-8 mb-4","children":"3. emmc에서 usb로 부팅 바꿔주기"}]
23:["$","p","p-35",{"children":"다음의 유튜브 영상을 참고하여 그대로 진행한다."}]
24:["$","p","p-36",{"children":["$","a","a-0",{"href":"https://www.youtube.com/watch?v=xwH2qfsvGio","children":"https://www.youtube.com/watch?v=xwH2qfsvGio"}]}]
25:["$","h3","h3-7",{"id":"j","className":"text-xl font-bold mt-6 mb-3","children":"jetson nano 내에서 입력하여 진행하면 된다."}]
26:["$","p","p-37",{"children":"yahboom jetson nano는 emmc에 올라간 부트로더 extlinux가 /dev/emmc블라블라 .."}]
27:["$","p","p-38",{"children":"그러니까 emmc를 루트파일시스템으로 잡고 있었는데"}]
28:["$","p","p-39",{"children":"이걸 usb에서 부팅할수 있도록 /boot/extlinux/extlinux.conf에서 루트파일시스템을 emmc가 아닌 /dev/sda1(위 영상의 경우)로 바꿔주면 된다고 한다."}]
29:["$","p","p-40",{"children":"문제는 2가지가 있었는데"}]
2a:["$","ol","ol-0",{"children":["\n",["$","li","li-0",{"children":"emmc에 깔린 jetpack 버전과 usb에 담긴 jetpack 버전이 같아야 한다."}],"\n",["$","li","li-1",{"children":"꽂은 usb가 /dev/sda1로 읽히는지 확인"}],"\n"]}]
2b:["$","p","p-41",{"children":["$","strong","strong-0",{"children":"2번의 경우, df를 입력하여주면 확인할 수 있다."}]}]
2c:["$","h3","h3-8",{"id":"$undefined","className":"text-xl font-bold mt-6 mb-3","children":["$","strong","strong-0",{"children":"입력 순서"}]}]
2d:["$","pre","pre-0",{"children":["$","code","code-0",{"className":"hljs language-jsx","children":["sudo apt-get update\nsudo apt-cache show nvidia-jetpack\n# 위에 코드로 버전 확인\ncd /boot/extlinux/\n\nsudo cp extlinux.",["$","span","span-0",{"className":"hljs-property","children":"conf"}]," extlinux.",["$","span","span-1",{"className":"hljs-property","children":"conf"}],".",["$","span","span-2",{"className":"hljs-property","children":"boot_emmc_backup"}],"\n\nls\nsudo vim extlinux.",["$","span","span-3",{"className":"hljs-property","children":"conf"}],"\n\n"]}]}]
2e:["$","p","p-42",{"children":["$","img","img-0",{"src":"https://user-images.githubusercontent.com/84653623/219853924-b24752a4-6d23-4c70-9fba-dd3824d141f4.png","alt":"20"}]}]
2f:["$","p","p-43",{"children":"이후 sudo reboot 하면 os가 완벽하게 설치된다!"}]
30:["$","p","p-44",{"children":"이후 id는 nano, pw는 yahboom으로 설정된다."}]
31:["$","h1","h1-1",{"id":"","className":"text-3xl font-bold mt-8 mb-4","children":"글을 마무리하며,,"}]
32:["$","p","p-45",{"children":"여기까지 따라오면 우선 yahboom내 linux os를 설치할 수 있게 됩니다.\n얼른 포스팅 했어야 했는데, 현생이 바쁘다보니....\n오늘 프로젝트 포스팅 마무리하고 다른 공부들도 올려야겠습니다."}]
33:["$","p","p-46",{"children":"다음 포스팅에서는 yolov5를 진행하기 위한 Jetson Nano 내 CUDA BUILD와 관련한 이야기를 해보도록 하겠습니다.\nPS. 추가 문의사항 및 질문은 환영합니다. 그를 통해 저도 더 성장할 수 있을테니까요. 긴 글 읽어주셔서 감사합니다."}]
34:["$","$L36",null,{}]
38:T190b,
