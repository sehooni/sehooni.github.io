...
53:I[3089,["182","static/chunks/app/%5Bslug%5D/page-ad31c54747687caf.js"],"default"]
54:I[4010,["182","static/chunks/app/%5Bslug%5D/page-ad31c54747687caf.js"],"default"]
10:["$","h3","h3-1",{"id":"","className":"text-xl font-bold mt-6 mb-3","children":"구글 드라이브 연동"}]
11:["$","p","p-8",{"children":"학습한 모델의 체크포인트는 구글 드라이브에 저장해 두었으므로, code 4-1을 실행하여 코랩 노트북과 자신의 구글 드라이브를 연동한다."}]
12:["$","h4","h4-1",{"children":"code 4-1"}]
13:["$","pre","pre-2",{"children":["$","code","code-0",{"className":"hljs language-python","children":[["$","span","span-0",{"className":"hljs-keyword","children":"from"}]," google.colab ",["$","span","span-1",{"className":"hljs-keyword","children":"import"}]," drive\ndrive.mount(",["$","span","span-2",{"className":"hljs-string","children":"'/gdrive'"}],", force_remount=",["$","span","span-3",{"className":"hljs-literal","children":"True"}],")\n"]}]}]
14:["$","pre","pre-3",{"children":["$","code","code-0",{"children":"Mounted at /gdrive\n"}]}]
15:["$","h3","h3-2",{"id":"","className":"text-xl font-bold mt-6 mb-3","children":"인퍼런스 설정"}]
16:["$","p","p-9",{"children":["각종 인퍼런스 설정을 수행한다. ",["$","code","code-0",{"children":"pretrained_model_name"}],"과 ",["$","code","code-1",{"children":"max_seq_length"}],", ",["$","code","code-2",{"children":"downstream_model_dir"}]," 모두 앞 트레인에서 적용한 그대로 입력하여야 한다."]}]
17:["$","h4","h4-2",{"children":"code 4-2"}]
18:["$","pre","pre-4",{"children":["$","code","code-0",{"className":"hljs language-python","children":[["$","span","span-0",{"className":"hljs-keyword","children":"from"}]," ratsnlp.nlpbook.classification ",["$","span","span-1",{"className":"hljs-keyword","children":"import"}]," ClassificationDeployArguments\nargs = ClassificationDeployArguments(\n    pretrained_model_name=",["$","span","span-2",{"className":"hljs-string","children":"\"beomi/kcbert-base\""}],",\n    downstream_model_dir=",["$","span","span-3",{"className":"hljs-string","children":"\"/gdrive/My Drive/nlpbook/checkpoint-paircls\""}],",\n    max_seq_length=",["$","span","span-4",{"className":"hljs-number","children":"64"}],",\n)\n"]}]}]
19:["$","pre","pre-5",{"children":["$","code","code-0",{"children":"downstream_model_checkpoint_fpath: /gdrive/My Drive/nlpbook/checkpoint-paircls/epoch=1-val_loss=0.82.ckpt\n"}]}]
...
1c:["$","p","p-10",{"children":"code 4-3을 실행해 토크나이저를 초기화한다."}]
1d:["$","h4","h4-3",{"children":"code 4-3"}]
...
1f:["$","h3","h3-4",{"id":"","className":"text-xl font-bold mt-6 mb-3","children":"체크포인트 로드"}]
20:["$","p","p-11",{"children":["code 4-4는 ",["$","code","code-0",{"children":"pair_classification_train.ipynb"}],"에서 파인튜닝한 모델의 체크포인트를 읽어 들인다."]}]
21:["$","h4","h4-4",{"children":"code 4-4"}]
22:["$","pre","pre-7",{"children":["$","code","code-0",{"className":"hljs language-python","children":[["$","span","span-0",{"className":"hljs-keyword","children":"import"}]," torch\nfine_tuned_model_ckpt = torch.load(\n    args.downstream_model_checkpoint_fpath,\n    map_location=torch.device(",["$","span","span-1",{"className":"hljs-string","children":"\"cpu\""}],"),\n)\n"]}]}]
23:["$","h3","h3-5",{"id":"b","className":"text-xl font-bold mt-6 mb-3","children":"BERT 설정 로드 및 BERT 모델 초기화"}]
24:["$","p","p-12",{"children":["code 4-5는 ",["$","code","code-0",{"children":"pair_classification_train.ipynb"}],"의 파인튜닝 때 사용한 ",["$","code","code-1",{"children":"pretrained_model_name"}],"에 해당하는 모델의 설정값들을 읽어들이며, code 4-6을 실행하면 해당 값대로 BERT 모델을 초기화 한다."]}]
25:["$","h4","h4-5",{"children":"code 4-5"}]
26:["$","pre","pre-8",{"children":["$","code","code-0",{"className":"hljs language-python","children":[["$","span","span-0",{"className":"hljs-keyword","children":"from"}]," transformers ",["$","span","span-1",{"className":"hljs-keyword","children":"import"}]," BertConfig\npretrained_model_config = BertConfig.from_pretrained(\n    args.pretrained_model_name,\n    num_labels=fine_tuned_model_ckpt[",["$","span","span-2",{"className":"hljs-string","children":"'state_dict'"}],"][",["$","span","span-3",{"className":"hljs-string","children":"'model.classifier.bias'"}],"].shape.numel(),\n)\n"]}]}]
27:["$","h4","h4-6",{"children":"code 4-6"}]
28:["$","pre","pre-9",{"children":["$","code","code-0",{"className":"hljs language-python","children":[["$","span","span-0",{"className":"hljs-keyword","children":"from"}]," transformers ",["$","span","span-1",{"className":"hljs-keyword","children":"import"}]," BertForSequenceClassification\nmodel = BertForSequenceClassification(pretrained_model_config)\n"]}]}]
29:["$","h3","h3-6",{"id":"","className":"text-xl font-bold mt-6 mb-3","children":"체크포인트 주입하기"}]
2a:["$","p","p-13",{"children":["code 4-7은 초기화한 ",["$","strong","strong-0",{"children":"BERT"}],"모델에 code 4-4의 체크포인트를 주입한다"]}]
2b:["$","h4","h4-7",{"children":"code 4-7"}]
...
2d:["$","pre","pre-11",{"children":["$","code","code-0",{"children":"<All keys matched successfully>\n"}]}]
2e:["$","h3","h3-7",{"id":"","className":"text-xl font-bold mt-6 mb-3","children":"평가 모드로 전환"}]
2f:["$","p","p-14",{"children":["이어서 code 4-8을 실행하면 모델이 평가모드로 전환되게 된다. ",["$","strong","strong-0",{"children":"드롭아웃 등 학습 때만 사용하는 기법들을 무효화하는 역할"}],"을 한다."]}]
30:["$","h4","h4-8",{"children":"code 4-8"}]
31:["$","pre","pre-12",{"children":["$","code","code-0",{"className":"hljs language-python","children":["model.",["$","span","span-0",{"className":"hljs-built_in","children":"eval"}],"()\n"]}]}]
4b:T348e,BertForSequenceClassification(
  (bert): BertModel(
...
4a:["$","$L54",null,{"content":"$55"}]
4c:["$","span","span-44",{"className":"hljs-string","children":["f\"중립 ",["$","span","span-0",{"className":"hljs-subst","children":"{neutral_prob}"}],"\""]}]
4d:["$","span","span-45",{"className":"hljs-string","children":"'entailment_width'"}]
4e:["$","span","span-46",{"className":"hljs-string","children":["f\"",["$","span","span-0",{"className":"hljs-subst","children":["{entailment_prob * ",["$","span","span-0",{"className":"hljs-number","children":"100"}],"}"]}],"%\""]}]
4f:["$","span","span-47",{"className":"hljs-string","children":"'contradiction_width'"}]
50:["$","span","span-48",{"className":"hljs-string","children":["f\"",["$","span","span-0",{"className":"hljs-subst","children":["{contradiction_prob * ",["$","span","span-0",{"className":"hljs-number","children":"100"}],"}"]}],"%\""]}]
51:["$","span","span-49",{"className":"hljs-string","children":"'neutral_width'"}]
52:["$","span","span-50",{"className":"hljs-string","children":["f\"",["$","span","span-0",{"className":"hljs-subst","children":["{neutral_prob * ",["$","span","span-0",{"className":"hljs-number","children":"100"}],"}"]}],"%\""]}]
