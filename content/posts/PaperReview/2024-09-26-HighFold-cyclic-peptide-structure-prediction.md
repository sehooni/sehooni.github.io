...
![CycPOEM Overview Architecture](/assets/images/2024-09-26-HighFold-cyclic-peptide-structure-prediction/image9.png)
...
CycPOEM 매트릭스의 각 원소에 들어갈 최단 위상 경로 거리를 도출하기 위해, HighFold는 그래프 최단 경로 탐색 알고리즘인 Floyd-Warshall을 변형한 **FCP 알고리즘**을 개발하여 적용했습니다.
...
![FCP Algorithm dynamic programming](/assets/images/2024-09-26-HighFold-cyclic-peptide-structure-prediction/image13.png)
...
![Block Diagonal Multimer positional matrix](/assets/images/2024-09-26-HighFold-cyclic-peptide-structure-prediction/image15.png)
...
![Monomer prediction performance comparisons](/assets/images/2024-09-26-HighFold-cyclic-peptide-structure-prediction/image22.png)
...
![Monomer 3D structure predictions](/assets/images/2024-09-26-HighFold-cyclic-peptide-structure-prediction/image23.png)
...
![Multimer target results](/assets/images/2024-09-26-HighFold-cyclic-peptide-structure-prediction/image25.png)
...
![Binding interface results](/assets/images/2024-09-26-HighFold-cyclic-peptide-structure-prediction/image26.png)
