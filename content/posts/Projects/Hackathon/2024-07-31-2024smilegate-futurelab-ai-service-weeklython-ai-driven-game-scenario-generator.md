...
excerpt: "스마일게이트 퓨처랩 주최 제1회 AI 서비스 위클리톤에서 대상을 수상한 GPT-4o 파인튜닝 기반의 게임 시나리오 생성 서비스 개발기 및 해커톤 회고"
categories:
  - Projects, Hackathon
tags:
  - Hackathon
...
대회가 끝나고 다른 팀들과의 질의응답을 통해 대회 당시 LLM-finetuning의 방법론에서 우리가 부족했던 부분을 파악할 수 있었는데, 학습 시 처음부터 학습 데이터를 많이 사용하는 것이 아니라, **few-shot learning을** 적용하면 기존 GPT의 성능을 유지하면서 우리가 원하는 결과를 얻을 수 있다는 점을 배웠습니다.
