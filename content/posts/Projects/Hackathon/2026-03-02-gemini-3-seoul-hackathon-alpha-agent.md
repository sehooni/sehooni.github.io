...
*   **GitHub**: [https://github.com/sehooni](https://github.com/sehooni) (Alpha-Agent: [Repository](https://github.com/sehooni/Alpha_Agent))
*   **Email**: 74sehoon@gmail.com
*   단백질 구조 모델링이나 AI 에이전트 협업 관련 문의는 언제든 환영합니다! :)
