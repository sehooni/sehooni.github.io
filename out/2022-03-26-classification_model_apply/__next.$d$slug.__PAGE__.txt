1:"$Sreact.fragment"
43:I[24170,["/_next/static/chunks/6b8d09032578b975.js"],"default"]
44:I[55132,["/_next/static/chunks/6b8d09032578b975.js"],"default"]
46:I[97367,["/_next/static/chunks/ff1a16fafef87110.js","/_next/static/chunks/865c404e1d9a0c65.js"],"OutletBoundary"]
47:"$Sreact.suspense"
...
9:["$","p","p-7",{"children":"각종 인자( 모델 하이퍼파라미터(hyperparameter)와 저장 위치 등 )를 설정한다."}]
a:["$","h4","h4-2",{"children":"code 2-2"}]
...
c:["$","pre","pre-5",{"children":["$","code","code-0",{"children":"downstream_model_checkpoint_fpath: /gdrive/My Drive/nlpbook/checkpoint-doccls/epoch=1-val_loss=0.28.ckpt\n"}]}]
d:["$","p","p-8",{"children":"각 인자의 역할과 내용은 다음과 같다."}]
...
f:["$","h2","h2-1",{"id":"2","className":"text-2xl font-bold mt-8 mb-4","children":"2. 토크나이저 및 모델 불러오기"}]
10:["$","h3","h3-3",{"id":"","className":"text-xl font-bold mt-6 mb-3","children":"토크나이저 로드"}]
11:["$","p","p-9",{"children":"code 2-3을 실행해 토크나이저를 초기화 한다."}]
12:["$","h4","h4-3",{"children":"code 2-3"}]
13:["$","pre","pre-6",{"children":["$","code","code-0",{"className":"hljs language-python","children":[["$","span","span-0",{"className":"hljs-keyword","children":"from"}]," transformers ",["$","span","span-1",{"className":"hljs-keyword","children":"import"}]," BertTokenizer\ntokenizer = BertTokenizer.from_pretrained(\n    args.pretrained_model_name,\n    do_lower_case=",["$","span","span-2",{"className":"hljs-literal","children":"False"}],",\n)\n"]}]}]
14:["$","pre","pre-7",{"children":["$","code","code-0",{"children":"Downloading:   0%|          | 0.00/250k [00:00<?, ?B/s]\n\n\n\nDownloading:   0%|          | 0.00/49.0 [00:00<?, ?B/s]\n\n\n\nDownloading:   0%|          | 0.00/619 [00:00<?, ?B/s]\n"}]}]
15:["$","h3","h3-4",{"id":"","className":"text-xl font-bold mt-6 mb-3","children":"체크포인트 로드"}]
16:["$","p","p-10",{"children":["code 2-4는 ",["$","code","code-0",{"children":"training_section.ipynb"}],"에서 파인튜닝한 모델의 체크포인트를 읽어들인다."]}]
17:["$","h4","h4-4",{"children":"code 2-4"}]
18:["$","pre","pre-8",{"children":["$","code","code-0",{"className":"hljs language-python","children":[["$","span","span-0",{"className":"hljs-keyword","children":"import"}]," torch\nfine_tuned_model_ckpt = torch.load(\n    args.downstream_model_checkpoint_fpath,\n    map_location=torch.device(",["$","span","span-1",{"className":"hljs-string","children":"\"cpu\""}],"),\n)\n"]}]}]
19:["$","h3","h3-5",{"id":"b","className":"text-xl font-bold mt-6 mb-3","children":"BERT 설정 로드 및 BERT 모델 초기화"}]
1a:["$","p","p-11",{"children":["code 2-5는 ",["$","code","code-0",{"children":"training_section.ipynb"}],"의 파인튜닝 때 사용한 ",["$","code","code-1",{"children":"pretrained_model_name"}],"에 해당하는 모델의 설정값들을 읽어들인다."]}]
1b:["$","p","p-12",{"children":["이어서 code 2-6을 실행하면 해당 설정값대로 ",["$","strong","strong-0",{"children":"BERT"}]," 모델을 초기화 한다."]}]
1c:["$","h4","h4-5",{"children":"code 2-5"}]
1d:["$","pre","pre-9",{"children":["$","code","code-0",{"className":"hljs language-python","children":[["$","span","span-0",{"className":"hljs-keyword","children":"from"}]," transformers ",["$","span","span-1",{"className":"hljs-keyword","children":"import"}]," BertConfig\npretrained_model_config = BertConfig.from_pretrained(\n    args.pretrained_model_name,\n    num_labels=fine_tuned_model_ckpt[",["$","span","span-2",{"className":"hljs-string","children":"\"state_dict\""}],"][",["$","span","span-3",{"className":"hljs-string","children":"\"model.classifier.bias\""}],"].shape.numel(),\n)\n"]}]}]
1e:["$","h4","h4-6",{"children":"code 2-6"}]
1f:["$","pre","pre-10",{"children":["$","code","code-0",{"className":"hljs language-python","children":[["$","span","span-0",{"className":"hljs-keyword","children":"from"}]," transformers ",["$","span","span-1",{"className":"hljs-keyword","children":"import"}]," BertForSequenceClassification\nmodel = BertForSequenceClassification(pretrained_model_config)\n"]}]}]
20:["$","h3","h3-6",{"id":"","className":"text-xl font-bold mt-6 mb-3","children":"체크포인트 주입하기"}]
21:["$","p","p-13",{"children":["code 2-7은 초기화한 ",["$","strong","strong-0",{"children":"BERT"}],"모델에 체크포인트(fine_tuned_model_ckpt)를 주입한다."]}]
22:["$","h4","h4-7",{"children":"code 2-7"}]
...
24:["$","pre","pre-12",{"children":["$","code","code-0",{"children":"<All keys matched successfully>\n"}]}]
25:["$","h3","h3-7",{"id":"","className":"text-xl font-bold mt-6 mb-3","children":"평가모드로 전환"}]
26:["$","p","p-14",{"children":["이어서 code 2-8을 실행하면 모델이 평가모드로 전환되게 된다. ",["$","strong","strong-0",{"children":"드롭아웃 등 학습 때만 사용하는 기법들을 무효화하는 역할"}],"을 한다."]}]
27:["$","h4","h4-8",{"children":"code 2-8"}]
28:["$","pre","pre-13",{"children":["$","code","code-0",{"className":"hljs language-python","children":["model.",["$","span","span-0",{"className":"hljs-built_in","children":"eval"}],"()\n"]}]}]
42:T348e,BertForSequenceClassification(
  (bert): BertModel(
...
![model_inference](https://user-images.githubusercontent.com/84653623/160078717-08773d8a-9907-448c-b490-7c68f2a84147.png)3e:["$","$L44",null,{"content":"$45"}]
3f:["$","link","0",{"rel":"stylesheet","href":"/_next/static/chunks/b9ef641e76e3a351.css","precedence":"next"}]
40:["$","script","script-0",{"src":"/_next/static/chunks/6b8d09032578b975.js","async":true}]
41:["$","$L46",null,{"children":["$","$47",null,{"name":"Next.MetadataOutlet","children":"$@48"}]}]
48:null
